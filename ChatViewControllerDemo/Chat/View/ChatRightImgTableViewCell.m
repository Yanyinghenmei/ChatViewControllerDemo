...
@interface ChatRightImgTableViewCell ()
...
@implementation ChatRightImgTableViewCell
...
- (CAShapeLayer *)shapeLayer {
    if (!_shapeLayer) {
        ...
        _shapeLayer.contents = (id)[UIImage imageNamed:@"liaotianbeijing2"].CGImage;
